...
local function createPlayerSub20(playerIdx)
    ...
    PlayerSub20.stick.x = ReadValueFloat(ptr, 0x14)
    PlayerSub20.stick.y = ReadValueFloat(ptr, 0x18)
...
local function createPlayerStats(playerIdx)
    ...
    -- acceleration
    PlayerStats.acceleration.standardA0 = ReadValueFloat(ptr, 0x24)
    PlayerStats.acceleration.standardA1 = ReadValueFloat(ptr, 0x28)
    PlayerStats.acceleration.standardA2 = ReadValueFloat(ptr, 0x2C)
    PlayerStats.acceleration.standardA3 = ReadValueFloat(ptr, 0x30)
    PlayerStats.acceleration.standardT1 = ReadValueFloat(ptr, 0x34)
    PlayerStats.acceleration.standardT2 = ReadValueFloat(ptr, 0x38)
    PlayerStats.acceleration.standardT3 = ReadValueFloat(ptr, 0x3C)
    PlayerStats.acceleration.driftA0 = ReadValueFloat(ptr, 0x40)
    PlayerStats.acceleration.driftA1 = ReadValueFloat(ptr, 0x44)
    PlayerStats.acceleration.driftA2 = ReadValueFloat(ptr, 0x48)
    -- turning (drift)
    PlayerStats.drift.manualHandling = ReadValueFloat(ptr, 0x4C)
    PlayerStats.drift.autoHandling = ReadValueFloat(ptr, 0x50)
    PlayerStats.drift.handlingReact = ReadValueFloat(ptr, 0x54)
    PlayerStats.drift.manualDrift = ReadValueFloat(ptr, 0x58)
    PlayerStats.drift.autoDrift = ReadValueFloat(ptr, 0x5C)
    PlayerStats.drift.driftReact = ReadValueFloat(ptr, 0x60)
    PlayerStats.drift.outsideDriftTargetAngle = ReadValueFloat(ptr, 0x64)
    PlayerStats.drift.outsideDriftDecrement = ReadValueFloat(ptr, 0x68)
    PlayerStats.mtDuration = ReadValue32(ptr, 0x6C)
    -- KCL flags
    PlayerStats.kcl.speed_00 = ReadValueFloat(ptr, 0x70)
    PlayerStats.kcl.speed_01 = ReadValueFloat(ptr, 0x74)
    PlayerStats.kcl.speed_02 = ReadValueFloat(ptr, 0x78)
    PlayerStats.kcl.speed_03 = ReadValueFloat(ptr, 0x7C)
    PlayerStats.kcl.speed_04 = ReadValueFloat(ptr, 0x80)
    PlayerStats.kcl.speed_05 = ReadValueFloat(ptr, 0x84)
    PlayerStats.kcl.speed_06 = ReadValueFloat(ptr, 0x88)
    PlayerStats.kcl.speed_07 = ReadValueFloat(ptr, 0x8C)
    PlayerStats.kcl.speed_08 = ReadValueFloat(ptr, 0x90)
    PlayerStats.kcl.speed_09 = ReadValueFloat(ptr, 0x94)
    PlayerStats.kcl.speed_0A = ReadValueFloat(ptr, 0x98)
    PlayerStats.kcl.speed_0B = ReadValueFloat(ptr, 0x9C)
    PlayerStats.kcl.speed_0C = ReadValueFloat(ptr, 0xA0)
    PlayerStats.kcl.speed_0D = ReadValueFloat(ptr, 0xA4)
    PlayerStats.kcl.speed_0E = ReadValueFloat(ptr, 0xA8)
    PlayerStats.kcl.speed_0F = ReadValueFloat(ptr, 0xAC)
    PlayerStats.kcl.speed_10 = ReadValueFloat(ptr, 0xB0)
    PlayerStats.kcl.speed_11 = ReadValueFloat(ptr, 0xB4)
    PlayerStats.kcl.speed_12 = ReadValueFloat(ptr, 0xB8)
    PlayerStats.kcl.speed_13 = ReadValueFloat(ptr, 0xBC)
    PlayerStats.kcl.speed_14 = ReadValueFloat(ptr, 0xC0)
    PlayerStats.kcl.speed_15 = ReadValueFloat(ptr, 0xC4)
    PlayerStats.kcl.speed_16 = ReadValueFloat(ptr, 0xC8)
    PlayerStats.kcl.speed_17 = ReadValueFloat(ptr, 0xCC)
    PlayerStats.kcl.speed_18 = ReadValueFloat(ptr, 0xD0)
    PlayerStats.kcl.speed_19 = ReadValueFloat(ptr, 0xD4)
    PlayerStats.kcl.speed_1A = ReadValueFloat(ptr, 0xD8)
    PlayerStats.kcl.speed_1B = ReadValueFloat(ptr, 0xDC)
    PlayerStats.kcl.speed_1C = ReadValueFloat(ptr, 0xE0)
    PlayerStats.kcl.speed_1D = ReadValueFloat(ptr, 0xE4)
    PlayerStats.kcl.speed_1E = ReadValueFloat(ptr, 0xE8)
    PlayerStats.kcl.speed_1F = ReadValueFloat(ptr, 0xEC)
    PlayerStats.kcl.rot_00 = ReadValueFloat(ptr, 0xF0)
    PlayerStats.kcl.rot_01 = ReadValueFloat(ptr, 0xF4)
    PlayerStats.kcl.rot_02 = ReadValueFloat(ptr, 0xF8)
    PlayerStats.kcl.rot_03 = ReadValueFloat(ptr, 0xFC)
    PlayerStats.kcl.rot_04 = ReadValueFloat(ptr, 0x100)
    PlayerStats.kcl.rot_05 = ReadValueFloat(ptr, 0x104)
    PlayerStats.kcl.rot_06 = ReadValueFloat(ptr, 0x108)
    PlayerStats.kcl.rot_07 = ReadValueFloat(ptr, 0x10C)
    PlayerStats.kcl.rot_08 = ReadValueFloat(ptr, 0x110)
    PlayerStats.kcl.rot_09 = ReadValueFloat(ptr, 0x114)
    PlayerStats.kcl.rot_0A = ReadValueFloat(ptr, 0x118)
    PlayerStats.kcl.rot_0B = ReadValueFloat(ptr, 0x11C)
    PlayerStats.kcl.rot_0C = ReadValueFloat(ptr, 0x120)
    PlayerStats.kcl.rot_0D = ReadValueFloat(ptr, 0x124)
    PlayerStats.kcl.rot_0E = ReadValueFloat(ptr, 0x128)
    PlayerStats.kcl.rot_0F = ReadValueFloat(ptr, 0x12C)
    PlayerStats.kcl.rot_10 = ReadValueFloat(ptr, 0x130)
    PlayerStats.kcl.rot_11 = ReadValueFloat(ptr, 0x134)
    PlayerStats.kcl.rot_12 = ReadValueFloat(ptr, 0x138)
    PlayerStats.kcl.rot_13 = ReadValueFloat(ptr, 0x13C)
    PlayerStats.kcl.rot_14 = ReadValueFloat(ptr, 0x140)
    PlayerStats.kcl.rot_15 = ReadValueFloat(ptr, 0x144)
    PlayerStats.kcl.rot_16 = ReadValueFloat(ptr, 0x148)
    PlayerStats.kcl.rot_17 = ReadValueFloat(ptr, 0x14C)
    PlayerStats.kcl.rot_18 = ReadValueFloat(ptr, 0x150)
    PlayerStats.kcl.rot_19 = ReadValueFloat(ptr, 0x154)
    PlayerStats.kcl.rot_1A = ReadValueFloat(ptr, 0x158)
    PlayerStats.kcl.rot_1B = ReadValueFloat(ptr, 0x15C)
    PlayerStats.kcl.rot_1C = ReadValueFloat(ptr, 0x160)
    PlayerStats.kcl.rot_1D = ReadValueFloat(ptr, 0x164)
    PlayerStats.kcl.rot_1E = ReadValueFloat(ptr, 0x168)
    PlayerStats.kcl.rot_1F = ReadValueFloat(ptr, 0x16C)
    -- misc (items may be slightly wrong)
    PlayerStats.items.radiusZ = ReadValueFloat(ptr, 0x170)
    PlayerStats.items.radiusX = ReadValueFloat(ptr, 0x174)
    PlayerStats.items.distanceY = ReadValueFloat(ptr, 0x178)
    PlayerStats.items.offset = ReadValueFloat(ptr, 0x17C)
...
local function createPlayerHitboxes(playerIdx)
    ...
    PlayerHitboxes.hitbox.h0 = ReadHitboxProperties(GetPointerNormal(ptr, 0x4, 0x0))
    PlayerHitboxes.hitbox.h1 = ReadHitboxProperties(GetPointerNormal(ptr, 0x1C, 0x0))
    PlayerHitboxes.hitbox.h2 = ReadHitboxProperties(GetPointerNormal(ptr, 0x34, 0x0))
    PlayerHitboxes.hitbox.h3 = ReadHitboxProperties(GetPointerNormal(ptr, 0x4C, 0x0))
    PlayerHitboxes.hitbox.h4 = ReadHitboxProperties(GetPointerNormal(ptr, 0x64, 0x0))
    PlayerHitboxes.hitbox.h5 = ReadHitboxProperties(GetPointerNormal(ptr, 0x7C, 0x0))
    PlayerHitboxes.hitbox.h6 = ReadHitboxProperties(GetPointerNormal(ptr, 0x94, 0x0))
    PlayerHitboxes.hitbox.h7 = ReadHitboxProperties(GetPointerNormal(ptr, 0xAC, 0x0))
    PlayerHitboxes.hitbox.h8 = ReadHitboxProperties(GetPointerNormal(ptr, 0xC4, 0x0))
    PlayerHitboxes.hitbox.h9 = ReadHitboxProperties(GetPointerNormal(ptr, 0xDC, 0x0))
    PlayerHitboxes.hitbox.hA = ReadHitboxProperties(GetPointerNormal(ptr, 0xF4, 0x0))
    PlayerHitboxes.hitbox.hB = ReadHitboxProperties(GetPointerNormal(ptr, 0x10C, 0x0))
    PlayerHitboxes.hitbox.hC = ReadHitboxProperties(GetPointerNormal(ptr, 0x124, 0x0))
    PlayerHitboxes.hitbox.hD = ReadHitboxProperties(GetPointerNormal(ptr, 0x13C, 0x0))
    PlayerHitboxes.hitbox.hE = ReadHitboxProperties(GetPointerNormal(ptr, 0x154, 0x0))
    PlayerHitboxes.hitbox.hF = ReadHitboxProperties(GetPointerNormal(ptr, 0x16C, 0x0))
    -- cuboid dimensions for inertia tensor
    PlayerHitboxes.cuboids.c0 = ReadVec3(GetPointerNormal(ptr, 0x184, 0x0))
    PlayerHitboxes.cuboids.c1 = ReadVec3(GetPointerNormal(ptr, 0x190, 0x0))

    PlayerHitboxes.rotSpeed = ReadValueFloat(ptr, 0x19C)
    -- wheel properties
    PlayerHitboxes.wheels.w0 = ReadWheelProperties(GetPointerNormal(ptr, 0x1A4, 0x0))
    PlayerHitboxes.wheels.w1 = ReadWheelProperties(GetPointerNormal(ptr, 0x1D0, 0x0))
    PlayerHitboxes.wheels.w2 = ReadWheelProperties(GetPointerNormal(ptr, 0x1FC, 0x0))
    PlayerHitboxes.wheels.w3 = ReadWheelProperties(GetPointerNormal(ptr, 0x228, 0x0))
...
local function createCollisionGroup(ptr)
    ...
    CollisionGroup.collisionData.types = ReadValue32(ptr, 0x8)
    CollisionGroup.collisionData.nor = ReadVec3(GetPointerNormal(ptr, 0xC, 0x0))
    CollisionGroup.collisionData.floorDir = ReadVec3(GetPointerNormal(ptr, 0x18, 0x0))
    CollisionGroup.collisionData.vel = ReadVec3(GetPointerNormal(ptr, 0x3C, 0x0))
    CollisionGroup.collisionData.relPos = ReadVec3(GetPointerNormal(ptr, 0x48, 0x0))
    CollisionGroup.collisionData.movement = ReadVec3(GetPointerNormal(ptr, 0x54, 0x0))
    CollisionGroup.collisionData.speedFactor = ReadValueFloat(ptr, 0x6C)
    CollisionGroup.collisionData.rotFactor = ReadValueFloat(ptr, 0x70)
    CollisionGroup.collisionData.closestFloorFlags = ReadValue32(ptr, 0x74)
    CollisionGroup.collisionData.closestFloorSettings = ReadValue32(ptr, 0x78)
    CollisionGroup.collisionData.intensity = ReadValue32(ptr, 0x84)
...
local function createRacedataScenario(scenarioIdx)
    ...
    RacedataScenario.players.p0 = createRacedataPlayer(scenarioIdx, 0x0)
    RacedataScenario.players.p1 = createRacedataPlayer(scenarioIdx, 0x1)
    RacedataScenario.players.p2 = createRacedataPlayer(scenarioIdx, 0x2)
    RacedataScenario.players.p3 = createRacedataPlayer(scenarioIdx, 0x3)
    RacedataScenario.players.p4 = createRacedataPlayer(scenarioIdx, 0x4)
    RacedataScenario.players.p5 = createRacedataPlayer(scenarioIdx, 0x5)
    RacedataScenario.players.p6 = createRacedataPlayer(scenarioIdx, 0x6)
    RacedataScenario.players.p7 = createRacedataPlayer(scenarioIdx, 0x7)
    RacedataScenario.players.p8 = createRacedataPlayer(scenarioIdx, 0x8)
    RacedataScenario.players.p9 = createRacedataPlayer(scenarioIdx, 0x9)
    RacedataScenario.players.pA = createRacedataPlayer(scenarioIdx, 0xA)
    RacedataScenario.players.pB = createRacedataPlayer(scenarioIdx, 0xB)
...
local function createRaceinfo()
    ...
    Raceinfo.players.p0 = createRaceinfoPlayer(0x0)
    Raceinfo.players.p1 = createRaceinfoPlayer(0x1)
    Raceinfo.players.p2 = createRaceinfoPlayer(0x2)
    Raceinfo.players.p3 = createRaceinfoPlayer(0x3)
    Raceinfo.players.p4 = createRaceinfoPlayer(0x4)
    Raceinfo.players.p5 = createRaceinfoPlayer(0x5)
    Raceinfo.players.p6 = createRaceinfoPlayer(0x6)
    Raceinfo.players.p7 = createRaceinfoPlayer(0x7)
    Raceinfo.players.p8 = createRaceinfoPlayer(0x8)
    Raceinfo.players.p9 = createRaceinfoPlayer(0x9)
    Raceinfo.players.pA = createRaceinfoPlayer(0xA)
    Raceinfo.players.pB = createRaceinfoPlayer(0xB)
